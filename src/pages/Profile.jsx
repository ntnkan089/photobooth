...
const Profile = () => {
  ...
  const handleChatClick = () => {
    window.location.href = `/chat/${profile.user_id}`;
          ...
          <div className="profile-text">
            ...
            {!isLoggedInUserProfile && (
              <>
                ...
                {!isFriend ? (
                  <button className="friend-button" onClick={friendClicked} disabled={loading}>
                    {loading ? "Loading..." : "Friend"}
                  </button>
                ) : (
                  <button className="friend-button unfriend-button" onClick={unfriendClicked} disabled={loading}>
